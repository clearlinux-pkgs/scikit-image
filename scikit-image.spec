...
Source0  : https://files.pythonhosted.org/packages/6e/be/a8ccf9d949a55023cf02438310e068c263ce3dd6bbf31f9229d3db6e551a/scikit-image-0.18.1.tar.gz
...
%prep
%setup -q -n scikit-image-0.18.1
cd %{_builddir}/scikit-image-0.18.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1609977362
...
cp %{_builddir}/scikit-image-0.18.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/scikit-image/9c5c45c8433b83e2ac82898a64d41746dec6f2fc
cp %{_builddir}/scikit-image-0.18.1/doc/tools/LICENSE.txt %{buildroot}/usr/share/package-licenses/scikit-image/fb50fd87a0153fd93be5975f012fa41347306040
